...
from app.dao.form_letter import get_form_letters_all, get_pr_form_codes, get_form_letters_pr
...
def form_letter_clone(form_letter_id):
    ...
    return redirect(url_for('form_letter_bp.form_letters', method=method, message=message))
...
def save_pr_defaults():
    if request.method == 'POST':
        ...
        return redirect(url_for('form_letter_bp.form_letters', message=message, method='payrequest'))
